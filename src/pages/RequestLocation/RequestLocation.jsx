...
function RequestLocation() {
    ...
    return (
        <>
            <div className="flex flex-col bg-background sm:h-screen pt-40 sm:pt-0 ">
                ...
                <div className="container mx-auto flex flex-col justify-center h-full   sm:px-0 px-4">
                    <section className="flex flex-row flex-wrap container justify-between mx-auto  text-secondary space-y-4 ">
