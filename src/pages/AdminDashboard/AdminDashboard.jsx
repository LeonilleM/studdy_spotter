            ...
            <div className="lg:block hidden">
                <div className="py-36 container mx-auto flex flex-col">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex">
                            <button
                                className={`px-4 py-2 ${selectedOption === 'campus' ? 'bg-accent ' : 'bg-gray-400 '} ${selectedOption !== 'location' ? 'border-r border-gray-300' : ''} rounded-l-lg`}
                                onClick={() => handleOptionChange('campus')}
                            >
                                Campus
                            </button>
                            <button
                                className={`px-4 py-2 ${selectedOption === 'location' ? 'bg-accent ' : 'bg-gray-400 '} rounded-r-lg`}
