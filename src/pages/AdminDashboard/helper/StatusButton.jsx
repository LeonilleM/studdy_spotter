...
export const statusButton = (status) => {
    if (status === 'Pending') {
        return (
            <div className="flex flex-row justify-center items-center ">
                <div className="border w-28 h-10 flex flex-row justify-center items-center gap-2 rounded py-2">
    ...
    if (status === 'Approved') {
        return (
            <div className="flex flex-row justify-center items-center">
                <div className="border w-28 h-10 flex flex-row justify-center items-center gap-2 rounded py-2 bg-green-100 border-green-200">
    ...
    if (status === 'Denied') {
        return (
            <div className="flex flex-row justify-center items-center">
                <div className="border w-28 h-10 flex flex-row justify-center items-center gap-2 rounded py-2 bg-red-100 border-red-200">
